...
"Hummus \nIngredients: \n- Chickpeas \n- Tahini \n- Fresh garlic \n- Fresh lemon juice, \n- Extra virgin olive oil \n- Water \nAllergens: \n- Sesame \n- Garlic \n- Chickpeas \n- Lemon \nHummus is a creamy, savory Middle Eastern dip made from chickpeas, tahini (sesame seed paste), olive oil, lemon juice, garlic, and a touch of salt. Its smooth texture and nutty, tangy flavor make it a versatile dish that can be paired with a variety of toppings and sides.",
...
"Fish Soup \nIngredients: \n- Fish: White fish (cod, haddock), salmon, or shellfish (shrimp, mussels) \n- Base: Fish or vegetable broth \n- Vegetables: Onion, garlic, tomatoes \n- Seasonings: Bay leaves, dill, parsley, salt, and pepper \nAllergens: \n- Fish and Shellfish \n- Garlic and Onion \n- Broth \nFish soup combines the umami of fish (like cod, haddock, or salmon) with the rich, briny notes of shellfish (shrimp or mussels) for a hearty, protein-packed dish. The base is often a fish or vegetable broth, enriched with aromatics like onion, garlic, and tomatoes. Fresh herbs like dill or parsley enhance the flavor.",
